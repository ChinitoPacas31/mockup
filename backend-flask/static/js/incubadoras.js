...
// Función para cambiar estado (actualizada para usar código)
function toggleIncubadora(codigo) {
  ...
  fetch(`/api/incubadora/${codigo}/toggle`, {
      method: 'POST'
  })
  .then(res => res.json())
  .then(data => {
